    ...
    <div class="form">
        ...
        <form action="" method="post">
           ...
           <label for="name">Nome</label>
            <input class="input-cadastro" type="text" name="user_name" id="name" placeholder="Seu Nome" required>

            <label for="email">E-mail</label>
            <input class="input-cadastro" type="email" name="user_email" id="email" placeholder="E-mail" required>

            <label for="senha">Palavra-passe</label>
            <input class="input-cadastro" type="password" name="user_password" id="senha" placeholder="crie uma Palavra-passe">
           ...
           <button class="styleb-m-auto btns004 style-display-block styleb-mt-2" type="submit">Continuar</button>
